...
# 设置中文字体（可选，推荐使用宋体 simsun.ttf）
try:
    font_path = 'C:/Windows/Fonts/simsun.ttc'  # Windows 宋体路径
...
# 网民规模柱状图
ax1.bar(x, population, width=0.4, color='cornflowerblue', label='网民规模（万人）')
ax1.set_ylabel('网民规模（万人）', fontproperties=font_prop)
ax1.set_xticks(x)
ax1.set_xticklabels(years, rotation=45, fontproperties=font_prop)
